...
class _BaseScreenState extends State<BaseScreen> {
  //Variável para alterar
  int currentIndex = 0;

  //Controlador PageView
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      //Criando paginação
      body: PageView(
        //Não ter rolagem manual para trocar as páginas
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        //OnTap - Retorna página ao clicar no menu Bottom
        onTap: (index) {
          setState(() {
            currentIndex = index;
            //pageController.jumpToPage(index);
            //animação na troca entre telas
